...
function BookingForm({ availableTimes, dispatchOnDateChange, submitForm }) {
  ...
  const { values, errors, touched, getFieldProps, handleSubmit } = useFormik({
    intialValues: {
      ...
      res_time: undefined,
      res_guests: 1,
      res_occasion: undefined,
      res_preference: undefined,
      res_name: "",
      res_email: "",
    },
    onSubmit: (values) => {
    ...
    validationSchema: yup.object({
      ...
      res_guests: yup
        ...
        .max(10, "Must be at most 1 guest"),
      res_occasion: yup
        .mixed()
        .required()
  ...
  return (
    <form id="booking_form" onSubmit={submitForm}>
      <div
        className="booking_form_view"
        id="input_view"
        hidden={inputConfirmed}
      >
        <h1>Book Now</h1>
        ...
        <div className="form_fields">
          ...
          <select
            id="res_occasion"
            name="res_occasion"
            // value={formData.res_occasion} onChange={(e) => { updateFormField(e) }}
            {...getFieldProps("res_occasion")}
          >
            {errors.res_occasion}
